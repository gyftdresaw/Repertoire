# HG edited simple good turing procedure to directly use count
# of counts dictionary (count of counts function is slow)
...
def simpleGoodTuringProbs(counts, ctsOfCts=None,confidenceLevel=1.96):
    '''
    HG edit to also take count of counts dictionary separately
    '''
    """
    Given a dictionary mapping keys (species) to counts, returns a dictionary
    ...
    '''
    HG edit return loglinear regression info
    '''
    return sgtProbs, p0, (rs,zs,a,b)
...
def plotFreqVsGoodTuring(counts, ctsOfCts=None, confidence=1.96, loglog=False):
    '''
    HG edit accepts count of counts dictionary for turing prob estimation
    '''
    """
    ...
    sgt, p0, reg_tuple = simpleGoodTuringProbs(counts, ctsOfCts, confidence)
